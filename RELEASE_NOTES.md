...
- اصلاحات: سخت‌سازی کراش اندروید — تعویض صحنه دیگر داخل回调 لمسی اجرا نمی‌شود، API صحیح هپتیک، محافظ دوضربه‌ای روی ردیف‌های منو، محافظ نودهای آزادشده؛ settle شدن دوربین؛ ۵۶۴ بررسی خودکار سبز در CI + APK عمومی امضاشده.
